...
const nav = [
  ...
  { to: "/cycles", label: "规则回测", icon: icon('<path d="M4 16l4-6 4 3 8-9"/><path d="M4 20h16"/>') },
  { to: "/emotions", label: "情绪资金", icon: icon('<path d="M4 14c2-6 6-9 8-9s6 3 8 9"/><path d="M4 18h16"/>') },
